...
for pol in policy_list[:-1]:
    d_pi_list.append(compute_discounted_visitation_matrix(P, pol, n_states, n_actions, g))


# Compute maximum value of zeta
...
plt.plot(max_bounds, marker='o', linestyle='None')
plt.savefig("figures/exact_ub.png")
